...
import { loadCharacterVisualConfig } from './utils/character-visual-config'
...
function AppRoutes() {
  ...
  // Load backend configs + preload sounds on app startup
  useEffect(() => { loadTiers(); loadCharacterVisualConfig(); preloadSounds() }, [])
