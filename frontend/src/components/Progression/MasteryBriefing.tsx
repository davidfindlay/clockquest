...
export function MasteryBriefing({ briefing, onStartQuest, onStartTrial, onLeaderboard }: MasteryBriefingProps) {
    ...
    <div className="flex flex-col gap-5 w-full max-w-lg mx-auto">
      ...
      {next_tier_name && (
        <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
          ...
          <div className="text-lg font-bold">{next_tier_name} ({next_tier_threshold})</div>
          {trialReady && (
